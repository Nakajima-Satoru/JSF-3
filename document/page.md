...
jsf3.pageメソッドの引数にそれぞれページ名、各種設定オブジェクトを設置します。
...
-  aタグを使って遷移先を指定
-  ボタンを押すイベントハンドラを設置して、jsf3.redirect.moveメソッドを使って遷移

後者のjsf3.redirect.moveメソッドを使用する方法については[こちらで解説しています・](redirect.md#move)  
...
JSF-3ではそのコールバックをjsf3.pageメソッドを使って簡単に実装することができます。
